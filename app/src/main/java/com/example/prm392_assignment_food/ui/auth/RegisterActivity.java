...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText etName, etEmail, etPassword, etRetypePassword, etPhone, etAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Logic được đơn giản hóa: trực tiếp yêu cầu OTP với vai trò mặc định
                requestOtp();
            }
        });
    }
    ...
    private void requestOtp() {
        ...
        // Gán cứng vai trò là "CUSTOMER" cho mọi đăng ký mới
        ...
        call.enqueue(new Callback<RegisterResponse>() {
            @Override
_            public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
